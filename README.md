...
**Our dataset (ours.tsv)** is constructed by manually labeling true or false labels on the triples extracted from Wikipedia texts by the state-of-the-art [BERT-based relation extractor](https://github.com/machinereading/bert-ko-re/).
